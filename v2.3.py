...
st.set_page_config(layout="wide", page_title="Enhanced Stock Dashboard v2.3 (by Sadiq)")
...
st.title("📈 Enhanced Stock Dashboard v2.3 (by Sadiq)")
st.caption("Advanced technical analysis with ML models, multi-source news, and strategy backtesting")

# Sidebar Configuration
st.sidebar.header("⚙️ Configuration")
group_choice = st.sidebar.radio("Market Cap Group", ["Big Cap (>100B USD)", "Medium Cap (>10B–100B USD)", "Small Cap (<10B USD)"])
